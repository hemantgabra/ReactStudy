      ...
      <div className="shadow-md">
        <div className="flex justify-around items-center px-3 py-2">
          ...
          <div className="relative" ref={loginDropdownRef}>
            ...
            {isLoginOpen && (
              <div className="absolute right-[-5]  w-[15rem] bg-white text-black border rounded-lg shadow-lg">
                ...
                <ul className="">
                  ...
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"> <FaRegUserCircle></FaRegUserCircle> Profile</Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><GiNinjaStar />Flipkart Plus Zone</Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><FaBoxOpen /> Orders </Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><CiHeart /> Wishlist </Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><FaGift /> Rewards</Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><TbGiftCardFilled />Gift Card</Link>
                  </li>
          ...
          <nav className="flex p-3 justify-center items-center gap-10 text-[1rem] font-medium">
            <Link to="/" className="gap-[0.5rem] flex items-center justify-center flex-row">
              <IoCartOutline className="text-[1.6rem] font-medium" />Cart</Link>

            <Link to="/aboutus" className="gap-[0.5rem] flex items-center justify-center flex-row">
            ...
            {isMenuOpen && (
              <div className="absolute left-[-10rem]  w-[17rem] bg-white text-black border rounded-lg shadow-lg">
                ...
                <ul className="">
                  ...
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><IoIosNotificationsOutline className="text-[1.2rem]" />Notificaiton Preference</Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><FaHeadphonesAlt className="text-[1.1rem]" />24*7 Customer Care</Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><MdOutlineAutoGraph className="text-[1.3erm]" /> Adverties </Link>
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer felx items-center justify-center flex-row">
                    <Link to="/" className="flex items-center gap-[0.5rem]"><FiDownload className="text-[1.3rem]" /> Download App</Link>
                  </li>
