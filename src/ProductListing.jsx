...
<div className='w-screen bg-white m-0 p-0'>
  {productData ? (
    <>
      <h1 className="text-2xl font-bold p-6 text-center">{productData.heading}</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 px-6 pb-6">
  ...
  <AiOutlineHeart className="relative -left-2 -bottom-2" size={24} />
    ...
    <p className="p-6">No product data available</p>
  )}
</div>
