      ...
      <div className="slider-container my-10 flex flex-col">
        <div className="w-[33rem]">
          ...
          <div className="grid grid-cols-2 gap-4 p-4 bg-white">
              ...
              >
                <div className="flex flex-col border-2 border-gray-200 p-5 rounded-md">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-full h-32 object-cover mb-2 transition-transform duration-300 hover:scale-105"
                  />
            ...
            {categories.map((cat) => (
              <div
                key={`cat-${cat.id}`}
                className="border border-gray-200 bg-white p-3 rounded shadow-md relative"
              >
                <img
                  src={cat.image}
                ...
                <button
                  ...
                  className="absolute top-2 left-2 bg-yellow-500 hover:bg-yellow-600 text-white px-2 py-1 text-xs rounded"
                >
                  Edit
                </button>
                <button
        ...
        <div className="shadow-lg rounded-lg">
          ...
          <div className="font-semibold flex text-[0.9rem] mt-3 px-1 shadow-lg items-center bg-gray-500 space-x-2">
            ...
            <button
              onClick={addcate}
              className="bg-blue-500 hover:bg-blue-600 p-2 text-[1rem] rounded-full mt-3 mb-3 text-white"
            >
              Upload Image
            </button>
          </div>
